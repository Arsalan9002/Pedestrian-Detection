...
class Tripline:
    ...
    def __init__(self, point_1=(0, 0), point_2=(100, 0), color=(255, 0, 0), stroke=2, buffer_size=10,
        ...
        if buffer_size is not None:
            ...
            self._buffer_1 = Tripline(point_1=buffer1_point_1, point_2=buffer1_point_2, color=color, stroke=1, buffer_size=None)
            ...
            self._buffer_2 = Tripline(point_1=buffer2_point_1, point_2=buffer2_point_2, color=color, stroke=1, buffer_size=None)
        else:
